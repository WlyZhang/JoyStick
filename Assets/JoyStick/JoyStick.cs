...
public class JoyStick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    void Start()
    {
        ...
        OnJoyStickTouchBegin += OnJoystickMoveStart;
        OnJoyStickTouchMove += OnJoystickMove;
        OnJoyStickTouchEnd += OnJoystickMoveEnd;
    }
    ...
    void OnJoystickMoveStart(Vector2 move)
    {
        ...
        Game.Instance.Loader.JoyStickTouchBegin(json);
    }
    ...
    void OnJoystickMove(Vector2 move)
    {
        ...
        Game.Instance.Loader.JoyStickTouchMove(json);
    }
    ...
    {
        Game.Instance.Loader.JoyStickTouchEnd();
    }
